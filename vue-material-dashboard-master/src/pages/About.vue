<template>
 <div :style="'margin-top: 70px'"> 
  <md-card class="md-card-profile">
    ...
    <md-card-content >
      <h4 class="category text-gray">Danmarks Tekniske Universitet</h4>
      ...
      <md-button class="md-round md-success" href="https://findit.dtu.dk/en/catalog/60cb2da5d9001d01665d1952">Go to Thesis</md-button>
