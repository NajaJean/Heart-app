...
public class ECGClassificationController {
	...
	public ResponseEntity<ECGClassification> get7LatestOfCertainMeasurement() {
		try {
			ECGClassification ecgClassification = ecgClassificationRepository.findFirstOrderByDatepostDesc();
