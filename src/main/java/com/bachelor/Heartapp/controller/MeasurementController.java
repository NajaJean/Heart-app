...
public class MeasurementController {
	...
	@GetMapping("/aau/measurements/{n}/{subject_id}/{pwd}/{measurement_type}")
	public ResponseEntity<List<Measurement>> getPatientsNAauMeasurements(@PathVariable("n") int n,
			@PathVariable("subject_id") String subject_id,
			@PathVariable("pwd") String pwd,
			@PathVariable("measurement_type") String measurement_type) {
		try {
